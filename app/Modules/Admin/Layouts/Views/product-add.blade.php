...
@section('content')
    <section>
        <div class="container-fluid">
            ...
            <form action="#" method="post" id="form-add-item">
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" id="form-control-service-period-wrapper" hidden>
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="service_period" id="period" class="form-control" min="1" value="1" />
...
@section('pageJs')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var itemCategory = document.querySelectorAll('#form-add-item select[name="category"]');
