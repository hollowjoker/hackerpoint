      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="section-contact__info"><i class="material-icons mr-5">email</i><span>hackdog@hello.ph</span></div>
            <div class="section-contact__info"><i class="material-icons mr-5">phone</i><span>+63 912 623 7886</span></div>
            <div class="section-contact__info"><i class="material-icons mr-5">place</i><span>903 Meadow Ln, Russellville, KY, 42276</span></div>
          </div>
          <div class="col-md-6">
            <h5>SAY HELLO</h5>
            <form action="">
