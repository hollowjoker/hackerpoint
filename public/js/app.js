...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__admin_Admin__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__front_Front__ = __webpack_require__(7);
...
var ADMIN = new __WEBPACK_IMPORTED_MODULE_1__admin_Admin__["a" /* default */](URL);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_datatables__ = __webpack_require__(6);
...
var Admin = function () {
  ...
  _createClass(Admin, [{
    ...
    value: function initDataTable() {
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#dtDashboard').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        searching: true,
        autoWidth: false,
        ajax: {
          url: __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#dtDashboard').attr('data-location')
        },
    ...
    value: function initLogin() {
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#loginForm').submit(function () {
        var formAction = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).attr('action');
        var formData = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).serialize();
